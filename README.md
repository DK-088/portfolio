...
| **Trainverse - E-Learning Platform** | Secure role-based learning platform featuring JWT authentication, course management, and admin dashboards. | AngularJS, Spring Boot, MySQL, JWT | [View](assets/images/TrainVerse.pptx) <br> [Code](https://github.com/DK-088?tab=repositories) |
| **Sign-Language Recognition System** | Real-time sign language interpreter achieving 90% accuracy using computer vision algorithms. | Python, OpenCV, Scikit-Learn, Mediapipe | [View](assets/images/REAL-TIME%20SIGN%20LANGUAGE%20DETECTION.pptx) <br> [Code](https://github.com/DK-088?tab=repositories) |
